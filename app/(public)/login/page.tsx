      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-slate-900 p-12 text-white">
        ...
        <div className="space-y-8">
          <h2 className="text-4xl font-bold leading-tight">
            The Operating System<br />for Modern Customs<br />Brokerage
          </h2>
          <div className="space-y-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">AI-powered parsing of commercial invoices, bills of lading, and customs forms.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-white/10">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Automated classification review, PGA screening, and audit trails for every action.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-white/10">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">State-machine driven case management from intake to release with real-time tracking.</p>
              </div>
            </div>
          </div>
        </div>
        <p className="text-xs text-slate-500">&copy; {new Date().getFullYear()} BizOS. All rights reserved.</p>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 lg:w-1/2 bg-white">
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <Link href="/signup" className="font-medium text-blue-600 hover:text-blue-700">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
